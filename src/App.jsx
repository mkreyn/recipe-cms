...
import { RecipeCategories } from "./pages/Recipes/RecipeCategories";
...
import RecipeLevels from "./components/Recipes/Levels/RecipeLevels";

function App() {
	const routes = [
		{ path: "/", element: <Home /> },
		{ path: "/recipes", element: <Recipes /> },
		{ path: "/recipes/categories", element: <RecipeCategories /> },
		{ path: "/recipes/levels", element: <RecipeLevels /> },
